...
export const getProducts = createAsyncThunk("product/getProducts", async ({ keyword, page, category = localStorage.getItem('category'), loweramount = 0, highamount = 10000, ratings = Number(localStorage.getItem('ratings')) }) => {
    page = page || 1;
    keyword = keyword || '';
